                        ...
                        <div className="col-lg-7 pt-4 pt-lg-0 content">
                            ...
                            <div className="row">
                                ...
                                <div className="col-12">
                                    <p className="my-3">
                                        Hi ! Thanks For Visiting My Profile, Currently I am looking for a good opportunity to enhance my knowledge. I would like to work as Frontend developer with the latest technology like a React Js.</p>
                                </div>
                            </div>
                        </div>
                    </div>
